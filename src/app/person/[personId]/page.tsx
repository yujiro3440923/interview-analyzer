        ...
        <div className="space-y-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border flex items-center gap-6">
                ...
                <div>
                    ...
                    <p className="text-slate-500">ID: {person.originalId || 'N/A'}</p>
                </div>
                <div className="ml-auto text-right">
                    <p className="text-sm text-slate-500">Total Consultations</p>
                    <p className="text-2xl font-bold text-slate-900">{person.records.length}</p>
                </div>
            </div>
                        ...
                        <div key={record.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                            ...
                            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded-xl border shadow-sm">
                                ...
                                <div className="space-y-2">
                                    <div>
                                        <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Problem</p>
